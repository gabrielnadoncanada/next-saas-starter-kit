...
import { getCurrentUser } from '@/shared/model/user';
import { normalizeUser } from '@/shared/model/user';
...
// Check if a user is the last owner of a team
export const isLastOwnerOfTeam = async (userId: string, teamId: string) => {
